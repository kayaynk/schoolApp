...
CREATE TABLE `classlesson` (
  ...
  CONSTRAINT `fk_classlesson_lesson` FOREIGN KEY (`ClassId`) REFERENCES `class` (`id`),
...
INSERT INTO `classlesson` VALUES (1,1,1),(3,2,2),(2,3,3);
...
-- Dump completed on 2021-10-29 19:43:24
